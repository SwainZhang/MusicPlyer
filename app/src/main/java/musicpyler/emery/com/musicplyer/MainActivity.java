package musicpyler.emery.com.musicplyer;
...
import utils.LrcUtil;
import utils.MediaUtils;
import views.LyricShow;
import views.ScrollableViewGroup;
...
public class MainActivity extends Activity implements OnClickListener {
	...
	public void reflash() {
		...
		/**---------------发送广播,让系统更新媒体数据库------此方法废弃改用MediaScanner---------**/
	...
	private void showNotification() {
        ...
        builder.setContentTitle("MusicPlayer");
